...
/* --- Component PDF Phiếu Thu chuẩn TT88 --- */
const ReceiptPDF = forwardRef(({ info }, ref) => {
  return (
    <div
      ref={ref}
    ...
    >
      ...
      <div className="text-center font-bold text-[16px] mt-4 mb-2">PHIẾU THU</div>
      <div className="flex justify-between mb-2">
        <div>Ngày ...... tháng ...... năm ......</div>
        <div>Quyển số: ............ &nbsp;&nbsp; Số: ....................</div>
      </div>

      <div className="mb-1">Họ và tên người nộp tiền: {info.payer || ".................................................."}</div>
      <div className="mb-1">Địa chỉ: {info.addressPayer || ".................................................."}</div>
      <div className="mb-1">Lý do nộp: {info.reason || ".................................................."}</div>
